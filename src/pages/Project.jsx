...
const projects = [
  {
    ...
    media: (
      <video
        src="src/assets/videos/Screen Recording 2025-07-16 at 00.44.09.mov"
        controls
  ...
  },
  {
    ...
    media: (
      <video
        src="src/assets/videos/Screen Recording 2025-07-16 at 00.56.24.mov"
        controls
        className="w-full h-full object-cover"
      />
    ),
  },
  {
    ...
    media: (
      <video
        src="src/assets/videos/Screen Recording 2025-07-16 at 00.52.08.mov"
        controls
        className="w-full h-full object-cover"
      />
    ),
